...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public JwtHelper(IConfiguration configuration)
        {
            ...
            /*IConfigurationSection ile Get kullanmak
             * her ikisini bir paket kullanmadan ayni anda kullanamayiz. bunun icin => Microsoft.Extensions.Configuration.Binder paketini kur
             */
        }
